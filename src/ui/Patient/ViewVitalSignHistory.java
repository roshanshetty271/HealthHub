...
public class ViewVitalSignHistory extends javax.swing.JPanel {
     ...
     */
    public ViewVitalSignHistory(JPanel userProcessContainer, Users users, UsersCatalog usersCatalog) {
        initComponents();
    ...
    {   
        ...
        int age = SysValidations.ageCalculation(person.getDob());
    ...
    private void initComponents() {
        ...
        BarCharJButton.setBackground(new java.awt.Color(0, 153, 255));
    ...
    private void BarCharJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BarCharJButtonActionPerformed
        ...
        if(selectedRow >= 0)
        {
            ...
            int systollicBP = vitalSigns.getSystolicBloodpressure();
            float weight = vitalSigns.getWeightInPounds();
            // Code for bar chart
            ...
            JFreeChart barchart = ChartFactory.createBarChart("Test Results on " + vitalSigns.getTimeStamp(),"Vital Signs" ,"Values", dataSet,PlotOrientation.VERTICAL, false, true, false);
